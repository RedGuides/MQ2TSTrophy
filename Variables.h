...
bool bAlchemistTrophy = false, bBakingTrophy = false, bBrewingTrophy = false, bFletchingTrophy = false, bJewelerTrophy = false, bTinkeringTrophy = false, bPotteryTrophy = false, bResearchTrophy = false, bBlacksmithTrophy = false, bTailorTrophy = false, bPoisonTrophy = false, bActivated = false, containerfound = false, bFishingTrophy = false;
